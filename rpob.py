...
s = socket.socket()
hints = ["The orc attacks the buffest character first", "When fighting with a ko                                                                                                             bold, you can only pray", "Goblin is smart. Weakest looking enemy will die first                                                                                                             ", "Be wary with the altar, young adventurer. For it can cause demise unknowingl                                                                                                             y.", "Unify your answers when faced with a statue, only then rewards will be rea                                                                                                             ped.", "Warping. The act of self degrading. In dire times, you can warp yourself                                                                                                              in the hopes that the enemy does not target you."]
